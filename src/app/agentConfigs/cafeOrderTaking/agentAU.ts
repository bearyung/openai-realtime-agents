...
import { cafeOrderTakingInstructionsAU } from './instructionsAU';

export const cafeOrderTakingAgentAU = new RealtimeAgent({
  name: 'English AU',
  voice: 'sage',
  handoffDescription: 'Cafe order taking agent (Australian English) - Warm, conversational service with a chat',
  
  instructions: cafeOrderTakingInstructionsAU,
